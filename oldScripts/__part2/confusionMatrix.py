...
# --------------------- Load data & model ---------------------
data = tf.data.Dataset.load('../../oldRessources/newDataValidation') # Load the data from a file
data = data.shuffle(1000)
data = data.batch(16)
data = data.prefetch(8)
#model = keras.models.load_model('../oldRessources/newModel.h5')
model = keras.models.load_model('../../oldRessources/newModel2.h5')
