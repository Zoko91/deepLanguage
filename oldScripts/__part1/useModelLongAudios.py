...
def extract_mfccs(wav,index):
    preprocessed_audio = preprocess(wav)
...
file_path = os.path.join('../../Audios', 'Journal.wav') # Fichier n'existe plus
...
language_index = tf.argmax(mean_predictions)
...
language_index = int(language_index.numpy())
# get the predicted language
language = language_mapping[language_index]
# get the probability of the predicted class
language_probability = mean_predictions[language_index]
