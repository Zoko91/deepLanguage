...
# Load the data (not available on github)
...
def create_model(input_shape=(13, 157, 1), num_classes=4):
    ...
    # A parallel layout has been tried with no particular improvement
...
model = create_model()
# Compile the model
optimizer = tf.keras.optimizers.Adam(learning_rate=0.0001) # Adam optimizer, learning rate can be improved
